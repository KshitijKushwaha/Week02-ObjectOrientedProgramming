public class Patient {
    ...
    public static void main(String[] args) {
        ...
        Patient patient2 = new Patient("Manoj", 25, "Cold", 102);
        Patient patient3 = new Patient("Aman Singh", 45, "Cough", 103);
        Patient patient4 = new Patient("Rita Verma", 60, "Asthma", 104);
